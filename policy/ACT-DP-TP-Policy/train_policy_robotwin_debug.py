...
DATA_DIR = '/attached/remote-home2/xhl/8_kaust_pj/RoboTwin/data_challenge/data_zarr'
...
def forward_pass(config, data, policy, stats=None, is_training=True, downsample_rate=1,device=None):
    if device == None:
    ...
    image_data, qpos_data, action_data, is_pad, future_imgs_data, is_pad_img = (
        ...
        is_pad.to(device),
        future_imgs_data.to(device),
        is_pad_img.to(device),
    )
