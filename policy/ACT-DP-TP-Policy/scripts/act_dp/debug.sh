...
python3 train_policy_robotwin.py \
    --task_name  $task_name \
    --ckpt_dir checkpoints/$task_name/act_dp/debug_${chunk_size}_${history_step}/seed_$seed/num_epochs_$num_epochs \
    --policy_class ACT_diffusion --hidden_dim 512  --batch_size 4 --dim_feedforward 3200 \
