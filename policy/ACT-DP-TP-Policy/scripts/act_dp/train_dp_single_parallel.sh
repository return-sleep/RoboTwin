...
CUDA_VISIBLE_DEVICES=0,1,3,5,6,7 python3 train_policy_robotwin_debug.py \
    --task_name  $task_name \
    --ckpt_dir checkpoints/$task_name/single_${chunk_size}_${history_step}_${num_epochs}_${num_episodes}_${backbone}/act_dp \
