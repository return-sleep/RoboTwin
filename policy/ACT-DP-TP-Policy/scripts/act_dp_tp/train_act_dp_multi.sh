...
CUDA_VISIBLE_DEVICES=1 python3 train_policy_robotwin.py \
    --task_name  $task_name \
    --ckpt_dir checkpoints/$task_name/act_dp_tp/dp_multi_${chunk_size}_${history_step}/num_epochs_$num_epochs \
    ...
    --seed 0 --num_episodes $num_episodes --resize_rate $resize_rate\
    --kl_weight 10 \
