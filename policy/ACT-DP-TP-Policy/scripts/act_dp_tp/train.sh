...
CUDA_VISIBLE_DEVICES=3 python3 train_policy_robotwin.py \
    --task_name  $task_name \
    ...
    --policy_class ACT_diffusion_tp --hidden_dim 512  --batch_size 4 --dim_feedforward 3200 \
    ...
    --rank 0 \
    --gpu 0 \
    --share_decoder --attention_type $attention_type --history_step 1 \
