...
bash eval.sh ${CONFIG_NAME#rdt_} D435 $CONFIG_NAME 10000 0 0 # mask offline embedding instruction    
...
# ssh xuhuilin@10.154.55.147 "mkdir -p /mnt/mydisk/Project_folder/0_RoboTwin/RoboTwin/policy/RDT/checkpoints/$CONFIG_NAME/checkpoint-10000/pytorch_model" && \
# rsync -avz checkpoints/$CONFIG_NAME/checkpoint-10000/pytorch_model/mp_rank_00_model_states.pt xuhuilin@10.154.55.147:/mnt/mydisk/Project_folder/0_RoboTwin/RoboTwin/policy/RDT/checkpoints/$CONFIG_NAME/checkpoint-10000/pytorch_model/


CONFIG_NAME="rdt_put_apple_cabinet"
CONFIG_FILE="model_config/$CONFIG_NAME.yml"
